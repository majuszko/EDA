...
def Zad6():
    ...
    print("Najpopularniejsze zenskie imie - Mary(4128052)\nNajpopularniejsze meskie imie - James(5177716)")
...
def Zad10():
    ...
    print("Najpopularniejsze damskie - Mary, Najpopularniejsze meskie - James")
